...
QA already validated this bead. Finalize should rerun the full test suite only when the target branch moved after QA completed, and should prefer targeted-affected tests before running the full suite.
